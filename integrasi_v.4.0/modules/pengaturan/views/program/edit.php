	...
	<div class="page-content-wrapper">
		<div class="page-content">
            ...
            <div class="note note-warning">
				<p>
					NOTE: Silahkan isi form Program ini dengan data-data yang valid!. Sesuai dengan arahan dari BAPPEDA Kabupaten Bekasi.
				</p>
			</div>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i>Ubah Program
							</div>
						</div>
										...
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
													...
													<a href="<?php echo site_url('pengaturan/program');?>" class="btn default"><i class="fa fa-times"></i> Batal</a>
												</div>
											</div>
										</div>
										<div class="col-md-6">
