				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i>Ubah Urusan
							</div>
						</div>
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="radio-list">
													...
													<input type="radio" name="jenis" id="jenis_wajib" value="wajib" <?php echo $jenis_wajib = ($jenis == 'wajib')?'checked':''; ?>> Wajib</label>
													<label class="radio-inline" for="jenis_pilihan">
													<input type="radio" name="jenis" id="jenis_pilihan" value="pilihan" <?php echo $jenis_pilihan = ($jenis == 'pilihan')?'checked':''; ?>> Pilihan</label>
												</div>
											</div>
										</div>
									</div>
									<div class="row">
										...
										<div class="col-md-10">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="urusan" id="urusan" value="<?php echo $urusan; ?>" placeholder="" required="required">
											</div>
										</div>
									</div>
								</div>
