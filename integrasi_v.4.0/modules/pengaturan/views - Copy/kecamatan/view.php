<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<h3 class="page-title">
			Daftar Kecamatan <small>entri data &amp; informasi detail</small>
			</h3>
			<div class="page-bar">
			...
			<div class="row">
				<div class="col-md-12">
                	<div class="portlet" align="right">
                		<a href="<?php echo site_url('pengaturan/kecamatan');?>" class="btn default"><i class="fa fa-times"></i> Bersihkan Hasil Pencarian </a>
                		<a href="<?php echo site_url('pengaturan/kecamatan/add');?>" class="btn green"><i class="fa fa-plus"></i> Tambah Kecamatan </a>
                    </div>
                </div>
            </div>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-bars"></i>Daftar Kecamatan
							</div>
						</div>
						<div class="portlet-body">
							...
							<tr>
                                ...
                                <th class="hidden-xs">Nama Kecamatan</th>
