...
class Kecamatan extends CI_Controller {
	...
	function datatable()
    {
        ...
        ->from('(SELECT @ROW_NUMBER  := @ROW_NUMBER + 1 as nomor, skpd_kode, skpd_nama, skpd_status, skpd_telepon, skpd_fax, skpd_pimpinan FROM (SELECT @ROW_NUMBER := 0) ROWNUMBER, skpd WHERE (skpd_status = \'Kecamatan\') ORDER BY skpd_nama ASC) skpd');
	...
	public function add()
	{
		...
		$container['sidebar']['view']					= 'admin/sidebar';
		$container['sidebar']['dataset']['aktive_menu'] = 20;
		$container['content']['view']					= 'pengaturan/kecamatan/add';
