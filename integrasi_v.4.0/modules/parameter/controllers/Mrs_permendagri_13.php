...
class Mrs_permendagri_13 extends CI_Controller {
	...
	public function index() {
		...
		$admin_log 	= $this->auth->is_login_admin();
		{
			...
			$container['content']['view']					= 'parameter/Mrs_permendagri_13/akun';
	...
	public function kelompok($id){
		$admin_log 	= $this->auth->is_login_admin();
		{
			...
			$container['content']['dataset']['title'] 		= "Rekening Permendagri 13";
			$container['content']['dataset']['title_header']= "Rekening Permendagri 13";
			$container['content']['view']					= 'parameter/Mrs_permendagri_13/kelompok';
	...
	public function jenis($id){
		...
		$admin_log 	= $this->auth->is_login_admin();
		{
			...
			$container['content']['dataset']['title'] 		= "Rekening Permendagri 13";
			$container['content']['dataset']['title_header']= "Rekening Permendagri 13";
			$container['content']['view']					= 'parameter/Mrs_permendagri_13/jenis';
			$this->Mapping_rekening_sap_model->Kd_Rek_1 				= $this->session->userdata('Mrs_Permen_13_Kd_Rek_1');
			$this->Mapping_rekening_sap_model->Kd_Rek_2 				= $id;

			$korolari = array(
			        	'Mrs_Permen_13_Kd_Rek_2'  => $id,
			);
	...
	public function obyek($id){
		$admin_log 	= $this->auth->is_login_admin();
		{
			...
			$container['content']['dataset']['title'] 		= "Rekening Permendagri 13";
			$container['content']['dataset']['title_header']= "Rekening Permendagri 13";
			$container['content']['view']					= 'parameter/Mrs_permendagri_13/obyek';
			$korolari = array(
			        	'Mrs_Permen_13_Kd_Rek_3'  => $id,
			);

			$this->session->set_userdata($korolari);
			
			$this->Mapping_rekening_sap_model->Kd_Rek_1 	= $this->session->userdata('Mrs_Permen_13_Kd_Rek_1');
			$this->Mapping_rekening_sap_model->Kd_Rek_2 	= $this->session->userdata('Mrs_Permen_13_Kd_Rek_2');
	...
	public function save($id){
		$admin_log 	= $this->auth->is_login_admin();
		{
			$container['sidebar']['view']					= 'admin/sidebar';
			$container['sidebar']['dataset']['aktive_menu'] = 60;
			$container['content']['view']					= 'parameter/Mrs_permendagri_13/rincian';
			$korolari = array(
			        	'Mrs_Permen_13_Kd_Rek_4'  => $id,
			);
