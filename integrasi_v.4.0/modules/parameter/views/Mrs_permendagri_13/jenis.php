                                    ...
                                    <div class="wizard">
                                        <div class="steps-index-container">
                                            <ul class="steps">
                                                ...
                                                <li class="completed pointer" onclick="href('<?=site_url("parameter/Mrs-permendagri-13/kelompok/{$this->session->userdata('KAR_Kd_Rek_1')}")?>')">
                                                    <span class="step-index">
                                                ...
                                                <tbody>
                                                    <?php foreach($data as $list):?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?= site_url('parameter/Mrs-permendagri-13/obyek/'.$list->Kd_Rek_3);?>">
                                                                <?= $list->Nm_Rek_3;?>
                                                                </a>
                                                            </td>
                                                        </tr>
