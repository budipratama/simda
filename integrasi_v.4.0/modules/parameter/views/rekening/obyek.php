                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane animated fadeInRight active" id="home_animation_2">
											...
											<tbody><?php if($completed):?><?php foreach($completed as $task):?>
												...
												<td><a href="<?php echo site_url('parameter/rekening/rincian/'.$task->task_id);?>"><?php echo $task->obyek_nama;?></a></td>
												<td style="text-align:center;">										
												<a class="btn btn-sm btn-warning" title="Ubah" href="<?php echo site_url('parameter/rekening/edito/'.$task->task_id);?>"><i class="fa fa-pencil"></i></a>
												<a class="btn btn-sm btn-danger" title="Hapus" onclick="return confirm('Are you sure?')" href="<?php echo site_url('parameter/rekening/deleteo/'.$task->task_id);?>/<?php echo $this->uri->segment(1); ?>" ><i class="fa fa-trash-o"></i></a>
												</td>
												</tr>
											<?php endforeach; ?></ul>
