            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						<h2>Rekening<small>Data Kelompok</small></h2>
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a title="Kembali" href="<?php echo site_url('parameter/rekening');?>"><i class="material-icons">reply</i> Kembali</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane animated fadeInRight active" id="home_animation_2">
											...
											<tbody><?php if($completed):?><?php foreach($completed as $task):?>
												<tr>
													...
													<td><a href="<?php echo site_url('parameter/rekening/jenis/'.$task->task_id);?>"><?php echo $task->kelompok_nama;?></a></td>
												</tr>
