            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
						...
						<h2>Unit Organisasi<small>Data Unit</small></h2>
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="<?php echo site_url('parameter/unit-organisasi/bidang/'.$urusan->tipe);?>"><i class="material-icons">reply</i> Kembali</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <!-- Nav tabs -->
                                     <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                        ...
                                        <li><p class="col-cyan"><a href="<?php echo site_url('parameter/unit-organisasi/bidang/'.$urusan->tipe);?>"><i class="material-icons">keyboard_arrow_left</i>Bidang</a></p></li>									
                                        <li role="presentation" class="active"><a href="#home_animation_2" data-toggle="tab">Unit</a></li>
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane animated fadeInRight active" id="home_animation_2">
											...
											<th style="text-align:center;">Uraian Nama Unit</th>
											</tr></thead>
												<tbody><?php if($completed):?><?php foreach($completed as $task):?>
													<tr>
													<td style="text-align:center;"><?php echo $task->tipe_id;?></td>
													<td style="text-align:center;"><?php echo $urusan->no;?></a></td>
													<td style="text-align:center;"><?php echo $task->skpd_no;?></a></td>
													<td><a href="<?php echo site_url('parameter/unit-organisasi/sub/'.$task->task_id);?>"><?php echo $task->skpd_nama;?></a></td>
													</tr>
