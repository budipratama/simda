                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <!-- Nav tabs -->
                                     <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                        ...
                                        <li role="presentation" class="active"><a href="#home_animation_2" data-toggle="tab">Bidang</a></li>
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane animated fadeInRight active" id="home_animation_2">
											...
											<th style="text-align:center; width:50px">Fungsi</th>
											</tr></thead>
												<tbody><?php if($completed):?><?php foreach($completed as $task): ?>
													...
													<td style="text-align:center;"><?php echo $task->fungsi; ?></a></td>
													</tr>
												  <?php endforeach; ?><?php else : ?><td>-</td><td>-</td><td style="text-align:center; width:500px">Tidak ada data pada tabel ini</td><?php endif; ?>
												</tbody>
											</table></p>
                                        </div>
                                    </div>
