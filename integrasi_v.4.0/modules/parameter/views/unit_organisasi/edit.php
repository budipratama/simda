                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									...
									<form action="<?php echo site_url('parameter/unit-organisasi/edit/'.$this_task->kode);?>" class="form-horizontal" method="post" >
									<input type="hidden" name="kode" value="<?php echo $this_task->kode; ?>"/>
									<input type="hidden" name="ccc_kode" value="<?php echo $this_task->skpd;?>" />
										<div role="tabpanel" class="tab-pane fade in active" id="step1" aria-labelledby="home-tab">
											...
											<table class="table table-striped table-bordered table-hover" width="50%" cellspacing="5" cellpadding="5">
												...
												<th style="text-align:center;">Uraian Nama Sub Unit</th>
													...
													<ul>
														<tr>
														<td style="text-align:center;"><input type="text" class="form-control" name="ddd_kode" value="<?php echo $this_task->no;?>" readonly="readonly"></td>
														<td><input type="text" class="form-control" name="sss_kode" value="<?php echo $this_task->sub_nama;?>" required="required"></td>
														</tr>
													</ul>
											</table>
