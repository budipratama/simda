                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="wizard">
                                        <div class="steps-index-container">
                                            <ul class="steps">
                                                <li class="completed pointer" onclick="href('<?=site_url("parameter/korolari-rekening-kredit")?>')">
                                                ...
                                                <tbody>
                                                    <?php foreach($data as $list):?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?= site_url('parameter/korolari-rekening-kredit/rincian/'.$list->Kd_Rek_4);?>">
                                                                <?= $list->Nm_Rek_4;?>
                                                                </a>
                                                            </td>
                                                        </tr>
