                                    ...
                                    <div class="wizard">
                                        <div class="steps-index-container">
                                            <ul class="steps">
                                                ...
                                                <li class="completed" onclick="href('<?=site_url("parameter/belanja-wajib-dan-mengikat/obyek/{$this->session->userdata('Kd_Rek_3')}")?>')">
                                                    <span class="step-index">
                                                ...
                                                <tbody>
                                                    <?php foreach($data as $list):?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?= site_url('parameter/belanja-wajib-dan-mengikat/save/'.$list->Kd_Rek_5);?>">
                                                                <?= $list->Nm_Rek_5;?>
                                                                </a>
                                                            </td>
                                                        </tr>
