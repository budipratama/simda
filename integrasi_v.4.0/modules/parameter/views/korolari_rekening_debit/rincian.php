                                    ...
                                    <div class="wizard">
                                        <div class="steps-index-container">
                                            <ul class="steps">
                                                ...
                                                <li class="completed pointer" onclick="href('<?=site_url("parameter/korolari-rekening-debit/jenis/{$this->session->userdata('KRD_Kd_Rek_2_debit')}")?>')">
                                                    <span class="step-index"><span class="label">3</span></span>
                                                    <span class="step-text">Jenis</span>
                                                    <span class="wiz-icon-chevron-right colorA"></span>
                                                    <span class="wiz-icon-chevron-right colorB"></span>
                                                </li>
                                                <li class="completed pointer" onclick="href('<?=site_url("parameter/korolari-rekening-debit/obyek/{$this->session->userdata('KRD_Kd_Rek_3_debit')}")?>')">
                                                    ...
                                                    <tbody>
                                                        <?php foreach($data as $row):?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?= site_url('parameter/korolari-rekening-debit/save/'.$row->Kd_Rek_5);?>">
                                                                    <?= $row->Nm_Rek_5;?>
                                                                    </a>
                                                                </td>
                                                            </tr>
