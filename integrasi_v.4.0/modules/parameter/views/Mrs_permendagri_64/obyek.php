                                    ...
                                    <div class="wizard">
                                        <div class="steps-index-container">
                                            <ul class="steps">
                                                ...
                                                <li class="completed pointer" onclick="href('<?=site_url("parameter/Mrs-permendagri-64/kelompok/{$this->session->userdata('MRA_Kd_Rek_1')}")?>')">
                                                    <span class="step-index">
                                                ...
                                                <li class="completed pointer" onclick="href('<?=site_url("parameter/Mrs-permendagri-64/jenis/{$this->session->userdata('MRA_Kd_Rek_2')}")?>')">
                                                    <span class="step-index">
                                                ...
                                                <tbody>
                                                    <?php foreach($data as $list):?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?= site_url('parameter/Mrs-permendagri-64/save/'.$list->Kd_Rek_4);?>">
                                                                <?= $list->Nm_Rek_4;?>
                                                                </a>
                                                            </td>
                                                        </tr>
