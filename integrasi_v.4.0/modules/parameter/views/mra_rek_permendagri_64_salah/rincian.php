                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="wizard">
                                        <div class="steps-index-container">
                                            <ul class="steps">
                                                <li class="completed pointer" onclick="href('<?=site_url("parameter/mra-rek-permendagri-64")?>')">
                                                ...
                                                <li class="completed pointer" onclick="href('<?=site_url("parameter/mra-rek-permendagri-64/kelompok/{$this->session->userdata('mra_rek_permendagri_64_akun')}")?>')">
                                                    <span class="step-index">
                                                ...
                                                <li class="completed pointer" onclick="href('<?=site_url("parameter/mra-rek-permendagri-64/jenis/{$this->session->userdata('mra_rek_permendagri_64_kelompok')}")?>')">
                                                    <span class="step-index">
                                                ...
                                                <li class="completed" onclick="href('<?=site_url("parameter/mra-rek-permendagri-64/obyek/{$this->session->userdata('mra_rek_permendagri_64_jenis')}")?>')">
                                                    <span class="step-index">
                                                ...
                                                <tbody>
                                                    <?php foreach($data as $list):?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="<?= site_url('parameter/mra-rek-permendagri-64/save/'.$list->no);?>">
                                                                <?= $list->rincian_nama;?>
                                                                </a>
                                                            </td>
                                                        </tr>
