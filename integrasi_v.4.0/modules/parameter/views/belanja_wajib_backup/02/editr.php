		...
		<div class="row">
            ...
            <div class="panel panel-primary">
				...
				<div class="step">
					...
					<form action="<?php echo site_url('parameter/belanja-wajib/edit/'.$this_task->kode);?>" class="form-horizontal" method="post"><br>
							...
							<table id="example1" class="table table-striped table-bordered table-hover">
								<thead><tr>
									...
									<tbody><?php if($completed) : ?><?php foreach($completed as $task) : ?>
										<tr>
										<td style="text-align:center;"><input type="text" class="form-control" name="aaa_kode" value="<?php echo $obyek->akun; ?>"><?php echo $task->akun_id; ?></td>
										<td style="text-align:center;"><input type="text" class="form-control" name="bbb_kode" value="<?php echo $obyek->kelompok; ?>"><?php echo $task->kelompok_id; ?></td>
										<td style="text-align:center;"><input type="text" class="form-control" name="ccc_kode" value="<?php echo $obyek->jenis; ?>"><?php echo $task->jenis_id; ?></td>
										<td style="text-align:center;"><input type="text" class="form-control" name="ddd_kode" value="<?php echo $obyek->kode; ?>"><?php echo $task->obyek_id; ?></td>
										<td style="text-align:center;"><input type="text" class="form-control" name="eee_kode" value="<?php echo $task->task_id; ?>"><?php echo $task->no; ?></td>
