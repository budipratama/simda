		...
		<div class="row">
            ...
            <div class="panel panel-primary">
				...
				<div class="step">
					...
					<form action="<?php echo site_url('parameter/belanja_wajib/add/'.$kode->id);?>" class="form-horizontal" method="post" >
							...
							<table id="example1" class="table table-striped table-bordered table-hover">
								<thead><tr>
									...
									<tbody><?php if($completed) : ?><?php foreach($completed as $task) : ?>
										...
										<td><button type="submit" class="btn btn-success"><?php if($stat == 'new'){ echo '<i class="fa fa-check"> </i>'; echo " Pilih"; } else { echo " Update"; } ?></button></td>
										</tr>
									<?php endforeach; ?></ul>
									<?php else : ?><td>-</td><td>-</td><td>-</td><td>-</td><td>-</td><td style="text-align:center; width:500px">Tidak ada data pada tabel ini</td><td>-</td><?php endif; ?>
							</table>
							</div>
						</div>
