	...
	<h3 class="page-title">Parameter <small> Belanja Wajib & Mengikat</small></h3>		
		<div class="row">
            ...
            <div class="panel panel-primary">
				<div class="panel-heading"><i class="fa fa-bars"></i> Data Akun</div>
							...
							<table id="example1" class="table table-striped table-bordered table-hover">
								<thead><tr>
									...
									<tbody><?php if(isset($akun)) : ?><?php foreach($akun as $list) : ?>
										...
										<td><a href="<?php echo base_url(); ?>parameter/belanja-wajib/kelompok/<?php echo $list->kode; ?>"><?php echo $list->akun_nama; ?></a></td>
										</tr>
