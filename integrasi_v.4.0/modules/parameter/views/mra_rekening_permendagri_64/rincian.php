        ...
        <h2>Parameter<small> <?=$title?></small></h2>  
            <div class="body">
                <ol class="breadcrumb breadcrumb-col-cyan">
                    ...
                    <li><a href="<?= site_url('parameter/mapping-rek-akrual');?>"> Mapping Rekening Akrual</a></li>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="wizard">
                                        <div class="steps-index-container">
                                            <ul class="steps">
                                                <li class="completed pointer" onclick="href('<?=site_url("parameter/Mra-rekening-permendagri-64")?>')">
                                                ...
                                                <li class="completed pointer" onclick="href('<?=site_url("parameter/Mra-rekening-permendagri-64/kelompok/{$this->session->userdata('P64_Kd_Rek_1')}")?>')">
                                                    <span class="step-index">
                                                ...
                                                <li class="completed pointer" onclick="href('<?=site_url("parameter/Mra-rekening-permendagri-64/jenis/{$this->session->userdata('P64_Kd_Rek_2')}")?>')">
                                                    <span class="step-index">
                                                ...
                                                <li class="completed" onclick="href('<?=site_url("parameter/Mra-rekening-permendagri-64/obyek/{$this->session->userdata('P64_Kd_Rek_3')}")?>')">
                                                    <span class="step-index">
                                            ...
                                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                                ...
                                                <tbody>
                                                    <?php foreach($data as $list):?>
                                                        <tr>
                                                            <td style="text-align:center;"><?= $list->Kd_Akrual_1;?></td>
                                                            <td style="text-align:center;"><?= $list->Kd_Akrual_2;?></td>
                                                            <td style="text-align:center;"><?= $list->Kd_Akrual_3;?></td>
                                                            <td style="text-align:center;"><?= $list->Kd_Akrual_4;?></td>
                                                            <td style="text-align:center;"><?= $list->Kd_Akrual_5;?></td>
                                                            <td>
                                                                <a href="<?= site_url('parameter/Mra-rekening-permendagri-64/save/'.$list->Kd_Akrual_5);?>">
                                                                <?= $list->Nm_Akrual_5;?>
                                                                </a>
                                                            </td>
                                                        </tr>
