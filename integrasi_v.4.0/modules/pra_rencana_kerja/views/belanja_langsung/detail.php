                    ...
                    <div class="card">
                        ...
                        <div class="body">
							...
							<h3 class="form-section"><b>Asumsi Biaya Pendanaan</b></h3>
								...
								<a href="<?php echo site_url('pra-rencana-kerja/edit/'.$kode);?>" class="btn btn-warning">Edit</a>
								<div class="btn-group" style="margin-left:100px;">
									<a href="<?php echo site_url('pra-rencana-kerja/transfer/'.$kode);?>" class="btn btn-info">Transfer ke Renja Murni Tahun <?php echo $tahun_anggaran;?></a>
								</div>
								<div class="btn-group" style="margin-left:50;">
									<a href="<?php echo site_url('pra-rencana-kerja/transfer-perubahan/'.$kode);?>" class="btn btn-success">Transfer ke Renja Perubahan Tahun <?php echo $tahun_anggaran;?></a>
									<!--<a href="<?php echo site_url('pra-rencana-kerja/transfer-perubahan/'.$kode);?>" class="btn btn-warning"><i class="fa fa-paper-plane"></i> Transfer ke Renja Perubahan Tahun <?php echo $tahun_sekarang;?></a>-->
								</div>										
                            </form>
							</div>
							</div>
