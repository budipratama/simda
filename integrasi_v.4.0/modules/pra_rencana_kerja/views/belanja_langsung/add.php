		...
		<h2>Pra Rencana Kerja <small> anggaran belanja langsung</small></h2>  
			<div class="body">
				<ol class="breadcrumb breadcrumb-col-cyan">
					...
					<li class="active"> Tambah Belanja Langsung</li>
				</ol>
			</div>	
                    ...
                    <div class="card">
						...
						<form action="<?php echo site_url('pra-rencana-kerja/insert/bl');?>" id="form_validation" enctype="multipart/form-data" method="POST">
							...
							<h3 class="form-section"><b>Asumsi Biaya Pendanaan</b></h3>
								...
								<div class="row clearfix">
									...
									<div class="col-md-1">
										<div class="form-group form-float">
										<div class="form-line">
											<input type="text" class="form-control" name="rt" id="rt" maxlength="3" required>
									...
									<div class="col-md-1">
										<div class="form-group form-float">
										<div class="form-line">
											<input type="text" class="form-control" name="rw" id="rw" maxlength="3" required>
							...
							<div class="row">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <textarea name="catatan" id= "catatan" cols="30" rows="1" class="form-control no-resize"></textarea>
