                        ...
                        <div class="body">
                            <div class="row clearfix">
								<div class="panel-heading" role="tab" id="headingOne_19" data-toggle="tooltip" data-placement="top" title="Form Pencairan">
									...
									<a href="<?php echo site_url('rup/murni');?>">
									<p class="col-cyan"><i class="material-icons">perm_contact_calendar</i> Form Pencairan</a></p>
                                           ...
                                           <div id="collapseOne_19" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne_19">
												...
												<form action="<?php echo site_url('rup/murni/cari');?>" class="form-horizontal" method="post">
													<div class="row clearfix">
														<div class="col-md-3">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><strong>Warning!</strong> Hapus SIRUP Murni</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"Rencana SIRUP Murni"</strong></font> telah berhasil dihapus !</font>
				</div>
...
<!-- #END# Multiple Items To Be Open -->
	...
	function show_form_deskel_by_kecamatan(){
		...
		load('rup/murni/tampil_combobox_deskel_by_kecamatan/'+kecamatan_kode, '#tampil_combobox_deskel_by_kecamatan');
	}
	</script>