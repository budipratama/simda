<!-- Main Content -->   
   <section class="content">
		<h2>KUA & PPAS Murni<small> entri data &amp; informasi detail</small></h2>  
			<div class="body">
				<ol class="breadcrumb breadcrumb-col-cyan">
					<li><a href="<?php echo site_url('dashboard');?>"><i class="material-icons">home</i> Home</a></li>
					<li><a href="<?php echo site_url('kua-ppas/murni');?>"> KUA & PPAS</a></li>
								...
								<div class="panel-heading" role="tab" id="headingOne_19" data-toggle="tooltip" data-placement="top" title="Form Pencairan">
									...
									<p class="col-cyan"><i class="material-icons">perm_contact_calendar</i> Form Pencairan</a></p>
                                           ...
                                           <div id="collapseOne_19" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne_19">
												...
												<form action="<?php echo site_url('kua-ppas/murni/cari');?>" class="form-horizontal" method="post">
													<div class="row clearfix">
														<div class="col-md-3">
										...
										<div class="portlet-body">
											...
											<tr>
												...
												<th>Nama Kegiatan</th>
												<th>Lokasi</th>
												<th style="width:80px;text-align:center;">Sumber</th>
												<th style="width:140px;text-align:center;">SKPD/Kecamatan</th>
												<th style="width:70px;text-align:center;">Transfer</th>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><strong>Success!</strong> Transfer KUA & PPAS Murni</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"KUA & PPAS Murni"</strong></font> telah berhasil ditransfer ke <font color="blue"><strong>"RKA Murni"</strong></font>
				</div>
	...
	<div id="warningTransfer" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Warning!</strong> Transfer KUA & PPAS Murni</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"KUA & PPAS Murni"</strong></font> sudah ditransfer ke <font color="blue"><strong>"RKA Murni"</strong></font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
	...
	<div id="successDelete" class="modal fade" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
					<h4 class="modal-title"><strong>Warning!</strong> Hapus KUA & PPAS Murni</h4>
				</div>
				<div class="modal-body">
					 Data <font color="green"><strong>"KUA & PPAS Murni"</strong></font> telah berhasil dihapus !</font>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn green" data-dismiss="modal">OK</button>
				</div>
...
<!-- #END# Multiple Items To Be Open -->
	...
	function show_form_deskel_by_kecamatan(){
		...
		load('kua_ppas/murni/tampil_combobox_deskel_by_kecamatan/'+kecamatan_kode, '#tampil_combobox_deskel_by_kecamatan');
	}
	</script>