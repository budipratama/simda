    ...
    <script src="<?php echo base_url('public/templates/integrasi_v.4.0/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js');?>"></script>
...
<!-- BEGIN PAGE LEVEL PLUGINS datepicker-->
<script src="<?php echo base_url('public/templates/integrasi_v.4.0/plugins/datepicker/js/bootstrap-datepicker.js');?>" type="text/javascript"></script>
